...
from config_card_matching import CARD_SUITS, CARD_RANKS
from trace_card_matching import Trace
...
def save_traces(output_tag, traces, debug=False):
    if debug:
        print(traces)
    with open('card_pattern_matching_{}.pik'.format(output_tag), 'wb') as f:
